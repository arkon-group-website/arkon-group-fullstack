      ...
      {services.map((service) => {
        ...
        return (
          <article key={service.slug} className="arkon-card">
            <div className="mb-5 grid h-12 w-12 place-items-center rounded-xl border border-arkon-gold/30 bg-arkon-gold/10 text-xl text-arkon-gold">
              ✦
            </div>
            ...
            <p className="mt-3 text-sm leading-7 text-arkon-muted">{t(locale, service.summary)}</p>
